      ...
      <div className="w-11/12 h-auto ">
        <div className="w-full  h-16 p-3 ">
          <div className="w-full h-10 flex justify-between items-end ml-4">
            ...
            <button className="w-28 h-6 bg-[#5B297E] flex justify-center items-center gap-1 rounded-sm text-white text-xs mb-2" onClick={() => { navigate('/Shipper/YourLoads') }}><IoCubeOutline className='font-semibold' />Your Loads</button>
          </div>
        </div>
