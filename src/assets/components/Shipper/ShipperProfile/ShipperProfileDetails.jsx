                ...
                <div className="w-full h-full ml-4  md:m-0 flex">
                      <div className="md:w-2/12 h-full  flex justify-center items-center">
                          <div className="w-28 h-28  rounded-full">
                              <img src="\images\786849530d99296dec0c9983fffa8e19.png" className='w-full h-full object-cover rounded-full object-[50%]' alt="" />
                          </div>
                      </div>
                      <div className=" w-5/12 md:w-4/12 h-full  flex justify-center items-center ml-2 md:ml-0">
                          <div className="w-full h-16 ">
                              <div className="w-full h-8 ">
                                  <h1 className='font-inter font-semibold text-base text-black'>Isacc Fleming</h1>
                              </div>
