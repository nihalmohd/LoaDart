...
import TripRequestLoad from './Loads/TripRequestLoad';
import TripRequestTruck from './Trucks/TripRequestTruck';

const TripRequestButton = () => {
    ...
    <div className="w-full h-auto flex justify-center items-center">
         <div className="w-11/12 h-auto  ">
             ...
             <div className="w-full h-auto mb-10 ">
                 {selectedDiv === 'left' && <TripRequestLoad/>}
                 {selectedDiv === 'right' && <TripRequestTruck/>}
             </div>
         </div>
     </div>
 </div>
