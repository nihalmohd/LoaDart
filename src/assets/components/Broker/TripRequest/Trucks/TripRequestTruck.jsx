...
<div className="w-full h-64 border border-black mt-5 rounded-lg shadow-md">
  ...
  <div className="flex items-center text-gray-600 mt-2 ml-2">
    ...
    <div className="w-full h-[50px] bg-[#D9D9D9] rounded-b-md  ">
            ...
            <div className="w-[140px] h-8 bg-[#5B297E] mt-3 ml-3 flex  justify-center items-center font-inter text-sm text-white rounded-sm shadow " onClick={()=>{navigate('/Broker/Loads')}} > Find load</div>        
            </div>
          </div>
</div>
</div>
...
export default TripRequestTruck