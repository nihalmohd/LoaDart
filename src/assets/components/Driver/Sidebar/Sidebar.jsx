        ...
        <div className='md:flex'>
            ...
            >
                ...
                <div className="flex flex-col items-center mb-8 mt-6">
                    <img
                        src="\images\85101537041c63d168dffa9de99742dd.png"
                        alt="Profile"
                        className="w-20 h-20 object-cover object-[20%] rounded-full mb-2"
                    />
                    <h2 className="text-lg font-semibold">James Mathew</h2>
                    ...
                    <div className="flex flex-col space-y-1">
                        ...
                        {isTrucksOpen && (
                            <div className="pl-10 text-gray-600 space-y-1">
                                ...
                                <a href="#" className="hover:text-[#5B297E] font-inter text-sm  flex justify-start  text-start items-center  text-gray-700 font-semibold" onClick={() => { handleMenuItemClick('Trucks') }}>Your Trucks</a>
                            </div>
                        )}
                    </div>
