...
import TripRequesLoad from './Load/TripRequestLoad';
import TripRequesTruck from './Truck/TripRequestTruck';

const TripRequestButtons = () => {
       ...
       <div className="w-full h-auto flex justify-center items-center">
            <div className="w-11/12 h-auto  ">
                ...
                <div className="w-full h-auto mb-10 ">
                    {selectedDiv === 'left' && <TripRequesLoad />}
                    {selectedDiv === 'right' && <TripRequesTruck />}
                </div>
            </div>
        </div>
    </div>
...
export default TripRequestButtons