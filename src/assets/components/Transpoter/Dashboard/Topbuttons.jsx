...
const Topbuttons = () => {
  return (
    ...
    <div className="w-full h-24 flex justify-between items-center">
      <div className="w-3/12 h-10  flex justify-start items-center ml-3 ">
        <h1 className='flex justify-center items-center text-lg font-inter font-semibold'>Hello, John <span className='ml-3 text-[#5B297E] text-xl flex relative'> <IoIosNotifications /> <div className="w-3 h-3 bg-red-500 rounded-full ml-3 absolute text-white text-xs text-center flex justify-center items-center">3</div></span></h1>
            ...
            <div className="w-6/12 h-10  grid grid-cols-4 gap-2 pt-3 ">
                <div className="w-full h-5  flex justify-center items-center ">
                    <form className="max-w-md mx-auto">
                        ...
                        <div className="relative">
                            ...
                            <input type="search" id="default-search" className="block w-full  ps-8 text-sm  border border-[#5B297E] rounded-sm text-[#5B297E]    " placeholder="Search Load" required />
                ...
                <div className="w-full h-5  flex justify-center items-center">
                    <form className="max-w-md mx-auto">
                        ...
                        <div className="relative">
                            ...
                            <input type="search" id="default-search" className="block w-full  ps-8 text-sm  border border-[#5B297E]   rounded-sm  " placeholder="Search Truck" required />
